...
path = "E:\学校的一些资料\文档\大二暑假\数据\切片2020_12_19"#文件夹目录
...
for file in files: #遍历文件夹
    ...
    for file2 in files2:
        ...
        with open(position2, 'r') as f:
            ...
            subname = ''.join(filter(lambda x: x >= 'a' and x <= 'z', file2[0:-4]))
            #print('subname:', subname)
            name='picture/' + subname + '/' +  file2[0:-4] #保存文件
